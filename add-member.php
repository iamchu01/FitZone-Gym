...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $membership = htmlspecialchars($row['membership']); // Adjust according to your database column name
                                            $membership_status = htmlspecialchars($row['membership_status']); // Adjust according to your database column name
                                            ...
                                            // Check for membership status and set default to "No Expiration Date"
                                            if (empty($membership_status)) {
                                                $membership_status_display = "No Expiration Date";
                                            } else {
                                            ...
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="member-profile.php?id=<?php echo $row['member_id']; ?>" class="avatar"><img src="assets/img/profiles/avatar-19.jpg" alt=""></a>
                                                        <a href="member-profile.php?id=<?php echo $row['member_id']; ?>"><?php echo $full_name; ?></a>
                                                    </h2>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dropdown action-label">
                                                        <a href="#" class="btn btn-white btn-sm btn-rounded dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i id="status-<?php echo $row['member_id']; ?>" class="fa fa-dot-circle-o <?php echo $status === 'Active' ? 'text-success' : 'text-danger'; ?>"></i> 
                                                            <span id="status-text-<?php echo $row['member_id']; ?>"><?php echo $status; ?></span>
                                                        </a>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $row['member_id']; ?>, 'Active')"><i class="fa fa-dot-circle-o text-success"></i> Active</a>
                                                            <a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $row['member_id']; ?>, 'Inactive')"><i class="fa fa-dot-circle-o text-danger"></i> Inactive</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a id="archive-link-<?php echo $row['member_id']; ?>" class="dropdown-item <?php echo ($status === 'Inactive') ? '' : 'disabled'; ?>" href="#" data-bs-toggle="modal" data-bs-target="#archive_member" data-id="<?php echo $row['member_id']; ?>" title="<?php echo ($status === 'Inactive') ? '' : 'Only inactive members can be archived'; ?>">
                                                                <i class="fa fa-archive m-r-5"></i> Archive
                                                            </a>
                                                            <a class="dropdown-item" href="#" onclick="renewMembership(<?php echo $row['member_id']; ?>)">
                                                                <i class="fa fa-refresh m-r-5"></i> Renew Membership
                                                            </a>
                                                            <a class="dropdown-item" href="#" onclick="cancelMembership(<?php echo $row['member_id']; ?>)">
                                                                <i class="fa fa-ban m-r-5"></i> Cancel Membership
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="addMemberForm" class="needs-validation member-info"  method="POST" action="process-add-member.php">
                            <div class="row">
                                <!-- Firstname -->
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>First Name <span class="text-danger">*</span></label>
                                        <input id="memberFirstname" class="form-control" type="text" name="firstname" placeholder="Enter First Name" required pattern="[A-Za-z\s]+">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="memberLastname" class="form-control" type="text" name="lastname" placeholder="Enter Last Name" required pattern="[A-Za-z\s]+">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" class="form-control" id="memberMobile" name="mobile" placeholder="ex. 9123456789" minlength="10" maxlength="10" pattern="9[0-9]{9}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-2">
                                        <label>Gender</label>
                                        <select class="form-select py-2" name="gender" id="memberGenderSelector">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" id="memberDateOfBirth" class="form-control datetimepicker" name="dateOfBirth" placeholder="Select Date of Birth">
                                            <small id="memberDateWarning" class="text-danger" style="display: none;">Please select a valid date of birth.</small>
                                        </div>
                                    </div>
                                </div>
                                <!-- Age -->
                                <div class="col-sm-6">
                                    <div class="form-group mb-2">
                                        <label>Age</label>
                                        <input type="text" id="memberAge" name="member_age" class="form-control" placeholder="Age" readonly>
                                    </div>
                                </div>
                                <!-- Email -->
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="memberEmail" name="email" placeholder="Enter Email" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="memberPassword" class="form-control" type="password" name="password" value="12345" readonly>
        ...
        <!-- //* Add Member  Success Modal -->
                ...
                <div class="modal fade" id="archive_member" tabindex="-1" role="dialog" aria-labelledby="confirmArchiveModalLabel" aria-hidden="true">
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                if (xhr.responseText.trim() === "success") {
                    ...
                    document.querySelector(`#status-${memberId}`).className = `fa fa-dot-circle-o ${newStatus === "Active" ? "text-success" : "text-danger"}`;
