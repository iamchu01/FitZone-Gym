                                    ...
                                    <div class="dropdown dropdown-action">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          <a class="dropdown-item"
                                             href="member-profile.php?id=<?php echo $row['member_id']; ?>">
                                          ...
                                          <a id="archive-link-<?php echo $row['member_id']; ?>"
                                             ...
                                             href="#" data-bs-toggle="modal" data-bs-target="#archive_member"
                     ...
                     <form id="addMemberForm" class="needs-validation member-info" method="POST"
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6">
                              <div class="form-group mb-2">
                                 <label>Age</label>
                                 <input type="text" id="memberAge" name="member_age" class="form-control"
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    <input id="memberPassword" class="form-control" type="password" name="password"
