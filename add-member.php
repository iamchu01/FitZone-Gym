...
<body>
     <div class="main-wrapper">
          ...
          <div class="page-wrapper">
                         ...
                         <div class="row align-items-center">
                              ...
                              <div class="col-auto float-end ms-auto">
                                   <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                        data-bs-target="#add_member"><i class="fa fa-plus"></i> Add Member</a>
                              </div>
                         </div>
                    </div>
                    <!-- /Page Header -->
                                                  ...
                                                  <tr>
                                                       <td>
                                                            <h2 class="table-avatar">
                                                                 <a href="member-profile.php?id=<?php echo $row['member_id']; ?>"
                                                                      class="avatar"><img
                                                                           src="assets/img/profiles/avatar-19.jpg"
                                                                           alt=""></a>
                                                                 <a
                                                                      href="member-profile.php?id=<?php echo $row['member_id']; ?>"><?php echo $full_name; ?></a>
                                                            </h2>
                                                       </td>
                                                       ...
                                                       <td>
                                                            <div class="dropdown action-label">
                                                                 <a href="#"
                                                                      ...
                                                                      <span
                                                                           id="status-text-<?php echo $row['member_id']; ?>"><?php echo $status; ?></span>
                                                                 </a>
                                                            ...
                                                            <div class="dropdown dropdown-action">
                                                                 ...
                                                                 <div class="dropdown-menu dropdown-menu-right">
                                                                      <a id="archive-link-<?php echo $row['member_id']; ?>"
                                                                           class="dropdown-item <?php echo ($status === 'Inactive') ? '' : 'disabled'; ?>"
                                                                           href="#" data-bs-toggle="modal"
                                                                           data-bs-target="#archive_member"
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <input id="memberFirstname" class="form-control" type="text"
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <input id="memberLastname" class="form-control" type="text"
                                                  ...
                                                  <div class="form-group">
                                                       <div class="input-group has-validation">
                                                            ...
                                                            <input type="text" class="form-control" id="memberMobile"
                                                                 name="mobile" placeholder="ex. 9123456789"
                                                                 minlength="10" maxlength="10" pattern="9[0-9]{9}">
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group mb-2">
                                                       ...
                                                       <div class="cal-icon">
                                                            <input type="text" id="memberDateOfBirth"
                                                                 class="form-control datetimepicker" name="dateOfBirth"
                                                                 placeholder="Select Date of Birth">
                                                            <small id="memberDateWarning" class="text-danger"
                                                                 style="display: none;">Please select a valid date of
                                                                 birth.</small>
                                                       </div>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group mb-2">
                                                       <label>Age</label>
                                                       <input type="text" id="memberAge" name="member_age"
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group">
                                                       ...
                                                       <div class="input-group">
                                                            <input id="memberPassword" class="form-control"
                                                                 type="password" name="password" value="12345" readonly>
                                                            <button class="btn btn-outline-secondary" type="button"
                                                                 id="toggleMemberPassword">
               ...
               <div class="modal fade" id="archive_member" tabindex="-1" role="dialog"
                    aria-labelledby="confirmArchiveModalLabel" aria-hidden="true">
                         ...
                         <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                   ...
                                   <button type="button" class="btn btn-primary"
                                        onclick="confirmArchiveMember()">Archive</button>
                              </div>
                         </div>
                    </div>
               </div>
