            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-6">
                <div class="hi-text">
                  ...
                  <h1>At <strong>Fit</strong> Zone</h1>
                  <a href="#" class="primary-btn">Became a member</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs-item">
              ...
              <p>
                ...
                incididunt ut dolore facilisis.
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="fs-about">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore dolore magna aliqua endisse ultrices gravida lorem.
              </p>
              <div class="fa-social">
