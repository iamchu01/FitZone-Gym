    ...
    <div class="page-wrapper">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-end ms-auto">
                        <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_instructor"><i class="fa fa-plus"></i> Add Instructors</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                                ...
                                                <td>
                                                    <div class="dropdown action-label">
                                                        <a href="#" class="btn btn-white btn-sm btn-rounded dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i id="status-<?php echo $row['instructor_id']; ?>" class="fa fa-dot-circle-o <?php echo $status === 'Active' ? 'text-success' : 'text-danger'; ?>"></i> 
                                                            <span id="status-text-<?php echo $row['instructor_id']; ?>"><?php echo $status; ?></span>
                                                        </a>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $row['instructor_id']; ?>, 'Active')"><i class="fa fa-dot-circle-o text-success"></i> Active</a>
                                                            <a class="dropdown-item" href="#" onclick="updateStatus(<?php echo $row['instructor_id']; ?>, 'Inactive')"><i class="fa fa-dot-circle-o text-danger"></i> Inactive</a>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <!-- /Page Content -->
          ...
          <!-- //* add instructor modal -->
                                                                ...
                                                                <div class="form-group mb-2" >
                                                                    ...
                                                                    <div class="position-relative" >
                                                                        <select class="form-select py-2" name="Gender" id="gender-selector" required>
                                                                            ...
                                                                            <option value="Others">Others</option> <!-- Ensure this option has the value "Others" -->
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal custom-modal fade" id="archive_instructor" tabindex="-1" role="dialog" aria-labelledby="archiveInstructorLabel" aria-hidden="true">
    ...
    function updateStatus(instructorId, newStatus) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                statusIconElement.className = `fa fa-dot-circle-o ${newStatus === "Active" ? "text-success" : "text-danger"}`;
