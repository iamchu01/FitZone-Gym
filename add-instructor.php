                         ...
                         <div class="row align-items-center">
                              ...
                              <div class="col-auto float-end ms-auto">
                                   <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                        data-bs-target="#add_instructor"><i class="fa fa-plus"></i> Add Instructors</a>
                              </div>
                         </div>
                    </div>
                    <!-- /Page Header -->
                                                       ...
                                                       <td>
                                                            <div class="dropdown action-label">
                                                                 <a href="#"
                                                                      ...
                                                                      <span
                                                                           id="status-text-<?php echo $row['instructor_id']; ?>"><?php echo $status; ?></span>
                                                                 </a>
                                                            ...
                                                            <div class="dropdown dropdown-action">
                                                                 ...
                                                                 <div class="dropdown-menu dropdown-menu-right">
                                                                      ...
                                                                      <a id="archive-link-<?php echo $row['instructor_id']; ?>"
                                                                           ...
                                                                           data-bs-target="#archive_instructor"
                                   ...
                                   <form id="addUserForm" class="needs-validation instructor-info" method="POST"
                                        ...
                                        <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                       <div class="input-group has-validation">
                                                            ...
                                                            <input type="text" class="form-control" id="mobile"
                                                                 name="mobile" placeholder="ex. 9123456789" required
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group mb-2">
                                                       ...
                                                       <div class="cal-icon">
                                                            ...
                                                            <small id="dateWarning" class="text-danger"
                                             ...
                                             <div class="col-sm-6">
                                                  <div class="form-group mb-2">
                                                       <label>Age</label>
                                                       <input type="text" id="age" name="instructor_age"
                                             ...
                                             <div class="form-group mt-3">
                                                  ...
                                                  <div class="position-relative">
                                                       ...
                                                       <textarea class="form-control" id="specializationTextarea"
                                                            name="specialization" rows="4"
                                                            placeholder="Enter specializations, separated by commas or new lines"
                                                            required></textarea>
                                                  </div>
                                             </div>
                                             <!-- //* new specialized field -->
