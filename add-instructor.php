                                    ...
                                    <div class="dropdown dropdown-action">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a id="archive-link-<?php echo $row['instructor_id']; ?>"
                                             ...
                                             href="#" data-bs-toggle="modal" data-bs-target="#archive_instructor"
                     ...
                     <form id="addUserForm" class="needs-validation instructor-info" method="POST"
                        ...
                        <div class="row">
                              ...
                              <div class="form-group">
                                 <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile"
                                       placeholder="ex. 9123456789" required minlength="10" maxlength="10"
                                       pattern="9[0-9]{9}">
                              ...
                              <div class="form-group mb-2">
                                 ...
                                 <div class="cal-icon">
                                    <input type="text" id="dateOfBirth" class="form-control datetimepicker"
                                       name="dateOfBirth" placeholder="Select Date of Birth" required>
                           ...
                           <div class="col-sm-6">
                              <div class="form-group mb-2">
                                 <label>Age</label>
                                 <input type="text" id="age" name="instructor_age" class="form-control"
                           ...
                           <div class="form-group mt-3">
                              ...
                              <div class="position-relative">
                                 ...
                                 <textarea class="form-control" id="specializationTextarea" name="specialization"
                                    rows="4" placeholder="Enter specializations, separated by commas or new lines"
                                    required></textarea>
                              </div>
                           </div>
                           <!-- //* new specialized field -->
