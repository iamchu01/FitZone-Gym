                                                ...
                                                <td>
                                                    <div class="dropdown action-label">
                                                        <a href="#" class="btn btn-white btn-sm btn-rounded dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="fa fa-dot-circle-o <?php echo $subscription['status'] === 'active' ? 'text-success' : 'text-danger'; ?>"></i>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="view-subscription-details.php?id=<?php echo $subscription['subscription_id']; ?>">
                                                                <i class="fa fa-eye m-r-5"></i> View Details
                                                            </a>
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#archive_subscription">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="subscriptionType" name="subscription_type_id" required onchange="updatePricingAndDuration()">
                                                    <option value="" disabled selected>Select Subscription Type</option>
                                                    <?php while ($type = $types_result->fetch_assoc()): ?>
                                                        <option value="<?php echo $type['subscription_type_id']; ?>" data-duration="<?php echo $type['duration_days']; ?>" data-price="<?php echo $type['price']; ?>">
