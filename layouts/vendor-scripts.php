...
<!-- Datetimepicker JS -->
	...
	<?php } if  ($page == 'stock-out.php' || $page == 'gym_equipment.php' || $page == 'categorie.php' || $page == 'product.php' ||$page == 'events.php' || $page == 'employees.php' || $page == 'employees-list.php') { ?>
<!-- Calendar JS -->
